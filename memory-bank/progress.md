...
下一步建议补齐个人说明书完整字段编辑，包括高能量来源、反复问题、行动建议风格和手动补充说明，并继续使用统一反馈提示。

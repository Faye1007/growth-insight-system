...
下一步建议新增月复盘入口，读取当月任务、习惯、打卡、日程、事件、灵感和已有周复盘，先生成不依赖 AI 的月度程序统计摘要。
